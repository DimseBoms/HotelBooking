...
class HotelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hotel" do
    assert_difference("Hotel.count") do
      post hotels_url, params: { hotel: { city: @hotel.city, name: @hotel.name, number_of_rooms: @hotel.number_of_rooms, room_price: @hotel.room_price } }
    end
  ...
  test "should update hotel" do
    patch hotel_url(@hotel), params: { hotel: { city: @hotel.city, name: @hotel.name, number_of_rooms: @hotel.number_of_rooms, room_price: @hotel.room_price } }
